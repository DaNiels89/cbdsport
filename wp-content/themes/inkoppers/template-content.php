...
<div class="container-fluid ink-my-4 mx-0">
    <div class="row">
        <div class="col-xl-10 offset-xl-1 background-image-contact">
...
<div class="container-fluid">
    <div class="row">
        <div class="column col-xl-6 offset-xl-2">
            ...
            <h2 class="degular-font fs-4080 ink-mb-2">Design and development for every stage of your journey.</h2>
        </div> 
    </div>
    <div class="row">
